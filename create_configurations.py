...
output_dir = '/home/agomez/Documents/iie/satelite/DATA/COMPARISON_MVS3D'
...
image_set_dir = '/media/agomez/SeagateGoFlex750GB/SATELITE/DATA/{0}_DATA/cropped_far_in_time/{0}_{1:03d}'.format(prefix, image_set)
gt_filename = '/media/agomez/SeagateGoFlex750GB/SATELITE/DATA/{0}_DATA/gt/{0}_{1:03d}_DSM.tif'.format(prefix, image_set)
output_dir = '/media/agomez/SeagateGoFlex750GB/SATELITE/DATA/COMPARISON_FAR_IN_TIME_{}'.format(prefix)
...
for pair in pair_list:
    ...
    #
    # --planesweep_exe
    # '/home/agomez/Software/MultiStereo/COLMAP/SatellitePlaneSweep/build/bin/satellitePlaneSweep'
    # --plyflatten_exe
    # /home/agomez/Software/satelite/s2p_ultimate/s2p/bin/plyflatten
    # --colmap_work_dir
    # /home/agomez/ownCloud/Documents/doctorado/MultiViewStereo/python/methods_comparison/jax_072_016_022_colmap
    # --planesweep_work_dir
    # /home/agomez/ownCloud/Documents/doctorado/MultiViewStereo/python/methods_comparison/jax_072_016_022_planesweep
    # --gt_image_filename
    # /home/agomez/Documents/iie/cursos_posgrado/Imagenes_Satelitales_2019/practico/JAX_IMAGES/JAX_072_DSM.tif
    # --ref_img_id
    # 0
    # --------------------------------------------------------------------------
